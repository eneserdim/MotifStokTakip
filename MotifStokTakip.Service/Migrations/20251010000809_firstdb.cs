        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoneWorksText = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceInvoices_ServiceOrders_ServiceOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServicePhotos_ServiceOrders_ServiceOrderId",
                        column: x => x.ServiceOrderId,
                        principalTable: "ServiceOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceInvoiceItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 10, 10, 0, 0, 0, 0, DateTimeKind.Utc), "Sistem Yöneticisi", true, false, "3eb3fe66b31e3b4d10fa70b5cad49c7112294af6ae4e476a1c405155d45aa121", 1, null, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceInvoiceItems_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceInvoices_ServiceOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicePhotos_ServiceOrderId",
                table: "ServicePhotos",
                column: "ServiceOrderId");
